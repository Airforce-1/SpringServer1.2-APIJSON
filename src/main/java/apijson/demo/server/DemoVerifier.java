...
import dyzb.server.model.Login;
...
public class DemoVerifier extends AbstractVerifier {
	...
	static { //注册权限
		...
		ACCESS_MAP.put(FeeInfo.class.getSimpleName(), getAccessMap(FeeInfo.class.getAnnotation(MethodAccess.class)));
		ACCESS_MAP.put(ResourceList.class.getSimpleName(), getAccessMap(ResourceList.class.getAnnotation(MethodAccess.class)));
	}
