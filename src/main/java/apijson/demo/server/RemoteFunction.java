 ...
 * @author Lemon
 */
public class RemoteFunction extends Function implements FunctionList {
	private static final String TAG = "RemoteFunction";

	//测试远程调用函数是否成功；在你的主机上调用的函数体在另外一台主机上。
	...
	public static final RemoteFunction instance = new RemoteFunction();
	/**反射调用
	 * @param jsonMap
